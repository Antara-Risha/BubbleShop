...
<html lang="en-US">
    ...
    <body data-spy="scroll" data-target="#main-navbar">
    	...
    	<div class="body">
                ...
                <nav id="main-navbar" class="navbar navbar-default navbar-fixed-top" role="navigation"> <!-- Classes: navbar-default, navbar-inverse, navbar-fixed-top, navbar-fixed-bottom, navbar-transparent. Note: If you use non-transparent navbar, set "height: 98px;" to #header -->
                  ...
                  <div class="container">
                    ...
                    <div class="navbar-header">
                      ...
                      <!-- <a class="navbar-brand page-scroll" href="<?php echo e(route('welcome')); ?>">The Bubble Shop</a> -->
                    </div>
			...
			<section id="text-carousel-intro-section" class="parallax" data-stellar-background-ratio="0.5" style="background-image: url(img/laundry.jpg);">
				...
				<div class="container">
					<div class="caption text-center text-white" data-stellar-ratio="0.7">
						...
						<div id="owl-intro-text" class="owl-carousel">
							<div class="item">
								<h1>The Bubble Shop</h1>
								<p>We take care of your cloths</p>
                                <div class="extra-space-l"></div>
								<a class="btn btn-blank" href="signup.html" target="_blank" role="button">SignUp</a>
								<a class="btn btn-blank" href="login.html" target="_blank" role="button">Login</a>
							</div>
							<div class="item">
								<h1>Join with us</h1>
...
<?php /**PATH F:\5th SEmester\BubbleShop\BubbleShop\resources\views/welcome.blade.php ENDPATH**/ ?>